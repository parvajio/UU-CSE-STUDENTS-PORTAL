...
// Upload → AI-extract → review → replace-all confirm flow.
// Live per-slot edit/delete lives in LiveRoutineSlotsTable below this card.
export default function RoutineUploadClient() {
