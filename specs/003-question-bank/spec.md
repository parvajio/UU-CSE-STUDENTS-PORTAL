...
- **SC-004**: Zero cases exist where a guest can obtain a question file — including direct-URL attempts, not just UI hiding — verified by a guest delegation test that requests the file URL and receives a denial every time.
